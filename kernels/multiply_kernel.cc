...
void MultiplyRawKernel(const Context& dev_ctx, const phi::DenseTensor& x,
                         const phi::DenseTensor& y, int axis,
                         phi::DenseTensor* out) {
...
PD_REGISTER_PLUGIN_KERNEL(multiply, Ascend910, ALL_LAYOUT,
                          custom_kernel::MultipyKernel, int8_t, int32_t,
                          int64_t, phi::dtype::float16, float, double) {}

PD_REGISTER_PLUGIN_KERNEL(multiply_raw, Ascend910, ALL_LAYOUT,
                          custom_kernel::MultiplyRawKernel, int8_t, int32_t,
                          int64_t, phi::dtype::float16, float, double) {}
