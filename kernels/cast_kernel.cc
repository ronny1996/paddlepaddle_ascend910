...
void CastKernel(const Context& dev_ctx, const phi::DenseTensor& x,
                 phi::DenseTensorMeta::DataType dtype, phi::DenseTensor* out) {
  if (x.dtype() == dtype) {
...
PD_REGISTER_PLUGIN_KERNEL(cast, Ascend910, ALL_LAYOUT,
                          custom_kernel::CastKernel, phi::dtype::float16,
